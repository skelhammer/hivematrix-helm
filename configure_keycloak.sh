...
if [ -n "$CLIENT_EXISTS" ]; then
    ...
    curl -s -X PUT "$KEYCLOAK_URL/admin/realms/hivematrix/clients/$EXISTING_CLIENT_ID" \
      ...
      -d "{
        ...
        \"redirectUris\": [\"http://127.0.0.1:5000/auth\", \"http://localhost:5000/auth\", \"http://127.0.0.1:5000/logout-callback\", \"http://localhost:5000/logout-callback\", \"http://127.0.0.1:5000/*\", \"http://localhost:5000/*\", \"https://localhost/keycloak-callback\", \"https://127.0.0.1/keycloak-callback\", \"https://localhost/*\", \"https://127.0.0.1/*\", \"https://${HOSTNAME}/keycloak-callback\", \"https://${HOSTNAME}/*\"],
        \"webOrigins\": [\"+\"],
        \"attributes\": {
